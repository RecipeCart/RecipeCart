...
void main() async {
  ...
  test("Testing searchRecipes", () {
    ...
    const allRelatedNames = [["cheese", "milk", "skimmed milk"], ["spaghetti", "pasta", "macaroni"]];
    final dietType = DietType.all.name;
    
    final recipes = recipeAPIService.searchRecipes(searchEntry, allRelatedNames, dietType, avoidances)
  });
}